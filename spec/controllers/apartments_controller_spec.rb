...
describe ApartmentsController do
  ...
  let(:valid_attributes) { { "designation_building" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved apartment as @apartment" do
        ...
        post :create, {:apartment => { "designation_building" => "invalid value" }}, valid_session
        expect(assigns(:apartment)).to be_a_new(Apartment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested apartment" do
        ...
        expect_any_instance_of(Apartment).to receive(:update).with({ "designation_building" => "MyString" })
        put :update, {:id => apartment.to_param, :apartment => { "designation_building" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the apartment as @apartment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Apartment.any_instance.stub(:save).and_return(false)
        put :update, {:id => apartment.to_param, :apartment => { "designation_building" => "invalid value" }}, valid_session
        expect(assigns(:apartment)).to eq(apartment)
      end
